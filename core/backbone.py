...
def cspdarknet53(input_data):
    ...
    pool1 = tf.keras.layers.MaxPool2D(pool_size=13, strides=1, padding='same')(input_data)
    pool2 = tf.keras.layers.MaxPool2D(pool_size=9, strides=1, padding='same')(input_data)
    pool3 = tf.keras.layers.MaxPool2D(pool_size=5, strides=1, padding='same')(input_data)
    input_data = tf.keras.layers.Concatenate(axis=-1)([pool1, pool2, pool3, input_data])
